...
import { AgentLicenseActivationCard } from "@/components/agent/AgentLicenseActivationCard";
...
const AgentDashboard = () => {
  const { user } = useAuth();
  const needsLicense = agentNeedsLicenseActivation(user);
      ...
      <main className="flex-1 ml-64 p-8">
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            <UserProfileAvatar user={user} sizeClassName="h-12 w-12" />
            <div>
