    ...
    <div className="min-h-screen bg-muted flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="mt-8 bg-card border border-border rounded-xl p-6 shadow-lg">
          <h3 className="text-sm font-semibold text-foreground mb-4 text-center">Quick Access to Dashboards</h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            <Link
              to="/admin"
              className="flex flex-col items-center justify-center p-4 border border-border rounded-lg hover:bg-primary/10 hover:border-primary transition-colors group"
            >
              <div className="w-10 h-10 rounded-full bg-primary/10 group-hover:bg-primary flex items-center justify-center mb-2 transition-colors">
                <span className="text-primary group-hover:text-primary-foreground font-bold text-sm">A</span>
              </div>
              <span className="text-xs font-medium text-foreground group-hover:text-primary">Admin</span>
            </Link>
            <Link
              to="/buyer"
              className="flex flex-col items-center justify-center p-4 border border-border rounded-lg hover:bg-primary/10 hover:border-primary transition-colors group"
            >
              <div className="w-10 h-10 rounded-full bg-primary/10 group-hover:bg-primary flex items-center justify-center mb-2 transition-colors">
                <span className="text-primary group-hover:text-primary-foreground font-bold text-sm">B</span>
              </div>
              <span className="text-xs font-medium text-foreground group-hover:text-primary">Buyer</span>
            </Link>
            <Link
              to="/seller"
              className="flex flex-col items-center justify-center p-4 border border-border rounded-lg hover:bg-primary/10 hover:border-primary transition-colors group"
            >
              <div className="w-10 h-10 rounded-full bg-primary/10 group-hover:bg-primary flex items-center justify-center mb-2 transition-colors">
                <span className="text-primary group-hover:text-primary-foreground font-bold text-sm">S</span>
              </div>
              <span className="text-xs font-medium text-foreground group-hover:text-primary">Seller</span>
            </Link>
            <Link
              to="/agent"
              className="flex flex-col items-center justify-center p-4 border border-border rounded-lg hover:bg-primary/10 hover:border-primary transition-colors group"
            >
              <div className="w-10 h-10 rounded-full bg-primary/10 group-hover:bg-primary flex items-center justify-center mb-2 transition-colors">
                <span className="text-primary group-hover:text-primary-foreground font-bold text-sm">Ag</span>
              </div>
              <span className="text-xs font-medium text-foreground group-hover:text-primary">Agent</span>
            </Link>
          </div>
          <p className="text-xs text-muted-foreground text-center mt-4">
            Click any dashboard above to explore (no login required for demo)
          </p>
        </div>
